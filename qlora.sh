...
#  --bnb=false --learning_rate=0.00005 --load_quant=$d/quant_cache/$MODEL-w4-g128-awq.pt --q_group_size 128 --lora_r=4
...
#   --learning_rate=0.00005 --load_awq=$d/awq_cache/$MODEL-w3-g128.pt --q_group_size 128 --lora_r=4

python qlora.py --model_name_or_path $d/$MODEL --batch_size=8 --do_eval=false --do_train=true \
  --omni_eval=true --dataset wikitext --awq=true --bits=0 --max_steps 2500 --bnb=false --learning_rate=0.00005 --lora_r=4
